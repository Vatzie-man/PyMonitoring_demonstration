...
class DjangoDataBase:
    ...
    def db_modification(self, data) -> None:
        ...
        def assign_ach_db(d):
            repo.update(d[1][0], title=v + "_Time_ACH", description=self.dict_for_db[d[1][1] + "_Time_ACH"], alert="non", other="non")
            repo.update(d[2][0], title=v + "_Fan", description=self.dict_for_db[d[2][1] + "_Fan"], alert="view_ach_detail_home", other="non")
            repo.update(d[3][0], title=v + "_Compressor", description=self.dict_for_db[d[3][1] + "_Compressor"], alert="view_ach_detail_home", other="non")
            repo.update(d[4][0], title=v + "_Pump", description=self.dict_for_db[d[4][1] + "_Pump"], alert="non", other="non")
            repo.update(d[5][0], title=v + "_Temp and Free", description=self.dict_for_db[d[5][1] + "_Temp and Free"], alert="non", other="non")
            repo.update(d[6][0], title=v + "_Condensing Pressure", description=self.dict_for_db[d[6][1] + "_Condensing Pressure"], alert="non", other="non")
            repo.update(d[7][0], title=v + "_Evaporating Pressure", description=self.dict_for_db[d[7][1] + "_Evaporating Pressure"], alert="non", other="non")
            repo.update(d[8][0], title=v + "_Saturation Temp", description=self.dict_for_db[d[8][1] + "_Saturation Temp"], alert="non", other="non")
            repo.update(d[9][0], title=v + "_Super Heating", description=self.dict_for_db[d[9][1] + "_Super Heating"], alert="non", other="non")
            repo.update(d[10][0], title=v + "_Liquid Temp", description=self.dict_for_db[d[10][1] + "_Liquid Temp"], alert="non", other="non")
            repo.update(d[11][0], title=v + "_Sub-Cooling", description=self.dict_for_db[d[11][1] + "_Sub-Cooling"], alert="non", other="non")
